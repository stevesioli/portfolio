...
const EXPERIENCE: ExperienceEntry[] = [
  {
    ...
    highlights: [
      'Architected and led delivery of a multi-tenant platform enabling multi-brand expansion, including launch of the Sports Illustrated Resorts and Eddie Bauer Adventure Club marketing sites.',
      ...
      'Prototyped Figma MCP integration within our web component library to expedite new component creation and updates to existing ones while maintaining code quality.',
      ...
      'Leveraged AI-assisted development (Cursor, Claude Code) to build automated migration tooling from a legacy site to modernized components.',
      'Designed front-end architecture to enable non-technical marketing teams to configure digital experiences through reusable CMS-driven components.',
  ...
  },
  {
    ...
    highlights: [
      "Authored architecture for Amazon's next-generation promotions platform, unifying Seller and Vendor Central experiences for 2.5M+ active sellers worldwide.",
      ...
      'Designed and built the front-end for a pan-region deal management capability, enabling sellers to manage promotions across multiple marketplaces through single sign-on.',
